						...
						<div role="tabpanel" class="tab-pane fade" id="form-stage-6">
							<div class="panel panel-default b-a bg-white-90">
								...
								<div class="panel-body">
									...
									<input type="submit" class="btn btn-success btn-lg m-b" value="<?php _e('Submit'); ?>"/>
					...
					<div class="panel panel-default b-a bg-white-90">
						...
						<div class="panel-body">
							...
							<div class="row m-t-xl m-b-sm">
								...
								<div class="col-sm-8">
									<div class=" input-group addon-right">
										<input id="first_name" class="form-control personal-setting" name="firstName" type="text" value="test" required>
							...
							<div class="row m-b-sm">
								...
								<div class="col-sm-8">
									<div class="input-group addon-right">
										<input id="last_name" class="form-control personal-setting" name="lastName" type="text" value="test" required>
										<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									</div>
								</div>
							</div>
							<div class="row m-b-sm">
								...
								<div class="col-sm-8">
									<div class="input-group addon-right">
										<input id="dob" class="form-control personal-setting date ignore" name="dob" type="tel" max="" value="01/01/1980" placeholder="dd/mm/yyyy">
										<label id="dob-error" class="" for="dob" style="display:none">Please enter a valid date.</label>
							...
							<div class="row m-b-sm">
								...
								<div class="col-sm-8">
									<div class=" input-group addon-right">
										<input id="your_email" class="form-control personal-setting" name="email" type="email" value="test@mail.com" required>
							...
							<div class="row m-b-sm">
								...
								<div class="col-sm-8">
									<div class=" input-group addon-right">
										<input id="your_phone" class="form-control personal-setting" maxlength="10" name="number" type="tel" value="1111111111" required>
							...
							<div class="row m-b-sm">
								...
								<div class="col-sm-8">
									<div class=" input-group addon-right">
										<input id="your_postcode" class="form-control personal-setting" maxlength="4" name="postcode" type="tel" value="1111" required>
							...
							<input type="submit" class="btn btn-success btn-lg m-b" value="Check if you qualify" >
...
function send_email_to_users($text, $subject, $user_query = false) { //this is function you'r looking for
...
function register_my_script() {
	wp_register_script('form-script', plugins_url('lead_form.js', __FILE__), array('jquery'), '1.0', true);
        wp_localize_script('form-script', 'lead_form_params', [
